...
public class ShopFloorGoodsController extends BaseController implements ShopFloorGoodsApiController {
     ...
     */
    @Override
    public ReturnData findFloorGoodsList(@PathVariable int sort, @PathVariable long shopId, @PathVariable int stock, @PathVariable int time, @PathVariable long goodsSort, @PathVariable int page, @PathVariable int count) {
        //验证参数
        if (page < 0 || count <= 0) {
