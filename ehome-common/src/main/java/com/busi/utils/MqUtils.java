...
public class MqUtils {
     ...
     * 更新钱包余额和钱包明细
     * @param userId          用户ID
     * @param tradeType       交易类型 0充值 1提现,2转账转入,3转账转出,4红包转入,5红包转出,6 点子转入,7点子转出,8悬赏转入,9悬赏转出,10兑换转入,11兑换支出,12红包退款,13二手购买转出,14二手出售转入,15家厨房转出,16家厨房转入,17购买会员支出,18游戏支出，19游戏转入,20任务奖励转入,21系统奖励转入,22购买靓号支出,23小时工支出,24小时工转入,25订座点菜支出,26订座点菜转入,27楼店交易转入,28楼店交易支出,29楼店缴纳保证金支出
     ...
     * 新增用户奖励记录
     * @param userId          用户ID
     * @param rewardType      奖励类型 0红包雨奖励 1新人注册奖励 2分享码邀请别人注册奖励 3生活圈首次发布视频奖励 4生活圈10赞奖励 5生活圈100赞奖励 6生活圈10000赞奖励 7是一级稿费作品 8是二级稿费作品 9是三级稿费作品 10是四级稿费作品
