...
public class RealNameUtils {
	...
	private String check_realname_url="https://v.apistore.cn/api/a1";//实名认证地址
	
	private String check_bankCard_url="https://v.apistore.cn/api/v4/verifybankcard4";//银行卡四元素认证地址
...
//	private String bankCard_key="4a3d1d6e4d0ffa8e1965ba7560a515c1";////银行卡四元素认证key
	...
	private String realname_key="381b395c0c9dfa8e06335ef948ffcba3";//实名认证key
	
	private String bankCard_key="e56266e81c79dd76edb09e8c111d3ced";////银行卡四元素认证key
...
//		String param="key="+realname_key+"&cardNo="+cardNo+"&realName="+realName+"&information=1";
//		String returnStr = null; // 返回结果定义
//		URL url = null;
//		HttpURLConnection httpURLConnection = null;
//
//		try {
//			url = new URL(check_realname_url);
...
//				int error_code = -1;
//				String reason = "";
//				error_code = jsonObj.getInt("error_code");//状态码
...
//							if(detailsJsonObj.getInt("sex")==0){//女
...
//							realNameInfo.setLength(detailsJsonObj.getInt("length"));
...
//		String param="key="+bankCard_key+"&bankcard="+bankCard+"&realName="+realName+"&cardNo="+cardNo+"&Mobile="+phone+"&cardtype=";
//		try {
//			url = new URL(check_bankCard_url);
//			httpURLConnection = (HttpURLConnection) url.openConnection();
//			httpURLConnection.setRequestProperty("Accept-Charset", "utf-8");
//			httpURLConnection.setRequestProperty("Content-Type", "application/x-www-form-urlencoded");
//			httpURLConnection.setDoOutput(true);
