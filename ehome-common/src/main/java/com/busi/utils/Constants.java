...
//    public static final int MSG_TIME_OUT_DAY_7 =60*60*24*7;//七天有效期
    ...
    public static final String ALIPAY_PID = "2088521070621170";//pid
    public static final String ALIPAY_PRIVATE_KEY = "";//私钥
    public static final String ALIPAY_PUBLIC_KEY = "/usr/local/webAppServer/paymentServer/appCertPublicKey_2016113003623646.crt";//公钥证书地址
    public static final String ALIPAY_ALIPAYCERTPUBLICKEY_KEY = "/usr/local/webAppServer/paymentServer/alipayCertPublicKey_RSA2.crt";//支付宝公钥证书文件路径
    public static final String ALIPAY_ALIPAYROOTCERT_KEY = "/usr/local/webAppServer/paymentServer/alipayRootCert.crt";//支付宝 CA 根证书文件路径
    /** 支付宝提现业务 单笔转账钱 结束**/
    ...
    public static final String REDIS_KEY_ADVERTPICADDRESS = "advert_pic_address";//APP过渡页key
    public static final String REDIS_KEY_ADMINI_HOMEPAGEINFO_FLAG = "admini_homePageInfo_flag";//苹果屏蔽主界面部分功能按钮 0关闭 1开启
...
//    public static final String REDIS_KEY_USER_VISIT_TOTAL_COUNT = "user_visit_totalCount";//总访问量
    ...
    public static final String REDIS_KEY_KITCHENDISHESLIST = "kitchenDishesList_";//厨房菜品信息对应关系 0厨房、1订座、2酒店、3景区
    ...
    public static final String REDIS_KEY_TRAVELORDERS = "travelOrders_";//userId与景区订单对象关系对照
    public static final String REDIS_KEY_TRAVEL_COMMENT = "travel_comment_list_";//景区创建者评论关系对照
    public static final String REDIS_KEY_TRAVEL_REPLY = "travel_reply_list_";//景区评论回复关系对照
    public static final String REDIS_KEY_HOTEL = "hotel_";//酒店民宿与userId关系对照
    public static final String REDIS_KEY_HOTELROOMLIST = "hotelRoomList_";//酒店民宿房间信息对应关系
    public static final String REDIS_KEY_HOTELORDERS = "hotelOrders_";//userId与酒店民宿订单对象关系对照
    public static final String REDIS_KEY_HOTEL_COMMENT = "hotel_comment_list_";//酒店民宿评论关系对照
    public static final String REDIS_KEY_HOTEL_REPLY = "hotel_reply_list_";//酒店民宿评论回复关系对照
    public static final String REDIS_KEY_PHARMACY = "pharmacy_";//药店与userId关系对照
    ...
    public static final String REDIS_KEY_DOORWAYBUSINESS = "doorwayBusiness_";//家门口商家与userId关系对照
    ...
    public static final String REDIS_KEY_HOMESHOP_CARTLIST = "homeShop_cartList_";//二货商城购物车列表与userId关系对照
    ...
    public static final String REDIS_KEY_USER_ADMINISTRATORS = "user_administrators";//userId与管理员关系对照
