...
public class PhoneService implements MessageAdapter {
    ...
    public void sendMsg(JSONObject body) {
        ...
        if(phoneType==0) {//注册发送短信
            ...
            content = "云家园提醒您，安全中心绑定手机验证码为：" + phoneCode + ",请您在10分钟之内使用，感谢您对云家园的关注与支持!";
        }else if(phoneType==3){//安全中心解绑手机验证码
            content = "云家园提醒您，安全中心解绑手机验证码为：" + phoneCode + ",请您在10分钟之内使用，感谢您对云家园的关注与支持!";
        }else if(phoneType==4){//手机短信找回登录密码验证码
            content = "云家园提醒您，找回登录密码验证码为：" + phoneCode + ",请您在10分钟之内使用，感谢您对云家园的关注与支持!";
        }else if(phoneType==5) {//手机短信修改密码验证码
            content = "云家园提醒您，修改密码验证码为：" + phoneCode + ",请您在10分钟之内使用，感谢您对云家园的关注与支持!";
