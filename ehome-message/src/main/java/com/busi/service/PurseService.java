...
public class PurseService implements MessageAdapter {
    ...
    public void sendMsg(JSONObject body) {
        try {
            ...
            //0充值 1提现,2转账转入,3转账转出,4红包转入,5红包转出,6 点子转入,7点子转出,8悬赏转入,9悬赏转出,10兑换转入,11兑换支出,12红包退款,13二手购买转出,14二手出售转入,15家厨房转出,16家厨房转入,17购买会员支出,18游戏支出，19游戏转入,20任务奖励转入,21系统奖励转入,22购买靓号支出,23小时工支出,24小时工转入,25订座点菜支出,26订座点菜转入,27楼店交易转入,28楼店交易支出,29楼店缴纳保证金支出
            ...
            if(userId<0||tradeType<0||tradeType>29||currencyType<0||currencyType>2){
