 ...
 * @description: 酒店民宿实体
 * @author: ZhaoJiaJie
 * @create: 2020-08-03 14:32:33
 */
@Setter
@Getter
public class Hotel {

    private long id;                    // 酒店&民宿ID
    ...
    private String closeTime;                // 酒店&民宿关闭时间 openType=1时有效

    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8")
    private Date addTime;            // 入驻时间

    private String licence;        //酒店&民宿证照

    private String picture;        //酒店&民宿图片

    private String videoUrl;        //视频地址

    private String videoCoverUrl;     //视频封面地址

    @Length(max = 140, message = "酒店&民宿贴士不能超过140字")
    private String tips;                //酒店&民宿贴士

    @Length(max = 2000, message = "酒店&民宿简介不能超过2000字")
    private String content;                //酒店&民宿简介
    ...
    private String type;            // 酒店&民宿类型

    private int levels;            // 酒店&民宿级别
    ...
    private String claimId;        // 入驻数据唯一标识符
