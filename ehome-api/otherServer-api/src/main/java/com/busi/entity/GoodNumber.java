...
public class GoodNumber {
    ...
    private String label;//数字类型 格式"#1#,#2#,#3#" 规则:0表示11A，1表示10A，2表示9A，3表示8A，4表示7A，5表示6A，6表示5A，7表示4A，8表示3A，9表示9顺，10表示8顺，11表示7顺，12表示6顺，13表示5顺，14表示4顺，15表示3顺，16表示AAABBB，17表示AABBCC，18表示ABABAB，19表示ABCABC，20表示AABB，21表示ABAB
