...
public class PharmacyOrder {
    ...
    private double money;            // 药品金额

    private String smallMap;            //药房头像
    ...
    private int distributionMode;            // 配送方式 0药店配送 1买家自取

    //与数据库无关字段
    private String ticketsIds;             //药品IDs

    private String ticketsNumber;           //药品数量
