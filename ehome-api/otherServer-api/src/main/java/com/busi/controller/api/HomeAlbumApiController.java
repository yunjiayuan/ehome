...
//    ReturnData resetAlbumPwd(@PathVariable long id);
     ...
     * @return
     */
    @GetMapping("findPicList/{albumId}/{type}/{userId}/{date}/{page}/{count}")
    ReturnData findPicList(@PathVariable long albumId, @PathVariable int type, @PathVariable long userId, @PathVariable int date, @PathVariable int page, @PathVariable int count);
