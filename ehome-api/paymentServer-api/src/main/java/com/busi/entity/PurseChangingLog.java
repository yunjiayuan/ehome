...
public class PurseChangingLog {
  ...
  @Max(value = 17, message = "tradeType参数有误，超出指定范围")
  @Min(value= -1 ,message= "tradeType参数有误，超出指定范围")
  private int tradeType;//交易类型 0充值 1提现,2转账转入,3转账转出,4红包转入,5红包转出,6 点子转入,7点子转出,8悬赏转入,9悬赏转出,10兑换转入,11兑换支出,12红包退款,13二手购买转出,14二手出售转入,15家厨房转出,16家厨房转入,17购买会员支出
