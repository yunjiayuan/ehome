...
/**
 * @program: ehome
 * @description: 家门口酒店民宿订单相关
 * @author: ZhaoJiaJie
 * @create: 2020-08-03 17:29:34
 */
@Service
public class HotelOrderService {

    @Autowired
    private HotelOrderDao travelOrderDao;
    ...
    public int addOrders(HotelOrder scenicSpotOrder) {
     ...
     * @return
     */
    public HotelOrder findById(long id, long userId, int type) {
     ...
     * @return
     */
    public HotelOrder findNo(String no) {
     ...
     */
    @Transactional(rollbackFor = {RuntimeException.class, Exception.class})
    public int updateOrders(HotelOrder scenicSpotOrder) {
     ...
     * @return
     */
    public PageBean<HotelOrder> findOrderList(int identity, long userId, int ordersType, int page, int count) {
