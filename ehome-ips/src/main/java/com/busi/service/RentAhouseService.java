...
public class RentAhouseService {
     ...
     * @return
     */
    public PageBean<RentAhouse> findRentAhouseList(long userId, int sellState, int leaseState, int sort, int nearby, int roomType, double lon, double lat, int province, int city,
                                                   int district, int minPrice, int maxPrice, double minArea, double maxArea, int orientation, int renovation, int floor, int bedroomType,
        ...
        list = kitchenBookedDao.findRentAhouseList(userId, sellState, leaseState, sort, nearby, roomType, lon,
