...
import com.busi.controller.local.RentAhouseOrderLocalController;
...
@FeignClient("ips")
@Component
public interface RentAhouseOrderLControllerFegin extends RentAhouseOrderLocalController {
